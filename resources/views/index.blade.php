...
<nav class="navbar navbar-expand-lg shadow p-3 bottom-under ml-2 mr-2 mt-2 bg-light rounded navbar-light bg-light">
  <a class="navbar-brand" href="#"><strong class="text-primary">Our </strong><strong class="text-dark">Arisan</strong></a>
...
<section class="section mt-3">
 ...
 <section class="mt-5 ml-5" id="section3">
  ...
  <div class="card-body">
    ...
    <p class="card-text">zibranfitadiyatamamodapk@gmail.com</p>
       ...
       <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <strong>Copyright &copy; <script>document.write(new Date().getFullYear());</script> Zibran 
                    </div>
                </div>
            </footer>
    </section>
